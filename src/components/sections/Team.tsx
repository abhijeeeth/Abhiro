...
const team = [
  ...
  },
  {
    ...
    bio: "Securing next-generation web platforms with robust penetration testing, vulnerability assessments, and secure architecture audits.",
    skills: ["Vulnerability Assessment", "Penetration Testing", "OWASP", "Secure Coding"],
  ...
  },
  {
    ...
    bio: "Architecting high-performance backend systems, managing database clustering, API integrations, and scalable cloud structures.",
  ...
  },
  {
    ...
    bio: "Crafting beautiful, accessible, and high-performance user interfaces with smooth micro-interactions and pixel-perfect responsiveness.",
  ...
  },
  {
    ...
    bio: "Delivering end-to-end web applications, bridging the gap between dynamic frontend designs and optimized server-side systems.",
  ...
  },
  {
    ...
    bio: "Building fluid and performant cross-platform mobile applications with custom animations and native-level integrations.",
    skills: ["Flutter", "Dart", "Firebase", "State Management", "REST APIs"],
    linkedin: "https://linkedin.com",
    github: "https://github.com",
    avatarGrad: "from-cyan-500 to-sky-600",
  },
  {
    name: "Bibin Thomas",
    role: "Senior Digital Marketing & SEO Analyst",
    bio: "Driving organic user growth and visibility through keyword optimization, technical SEO diagnostics, and target-driven marketing strategies.",
    skills: ["Technical SEO", "Google Analytics", "Keyword Research", "Growth Marketing"],
    linkedin: "https://linkedin.com",
    github: "https://github.com",
